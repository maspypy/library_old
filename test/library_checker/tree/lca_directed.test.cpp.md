...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/tree/lca_directed.test.cpp\"\n#define\
    ...
    \ ids;\n}\n#line 3 \"test/library_checker/tree/lca_directed.test.cpp\"\n\n#line\
    \ 2 \"graph/base.hpp\"\n\ntemplate <typename T>\nstruct Edge {\n  int frm, to;\n\
    ...
    root\", root);\r\n  }\r\n};\r\n#line 5 \"test/library_checker/tree/lca_directed.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, Q);\n  Graph<int, 1> G(N);\n  FOR3(v, 1, N) {\n  \
    \  LL(p);\n    G.add(p, v);\n  }\n  G.prepare();\n  HLD hld(G);\n\n  FOR(_, Q)\
    \ {\n    LL(a, b);\n    print(hld.LCA(a, b));\n  }\n}\n\nsigned main() {\n  cin.tie(nullptr);\n\
  ...
  requiredBy: []
  timestamp: '2022-02-04 11:52:32+09:00'
