...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/convolution/bitwise_and_convolution.test.hpp\"\
    ...
    \ UNIQUE(x) sort(all(x)), x.erase(unique(all(x)), x.end())\n#line 3 \"test/library_checker/convolution/bitwise_and_convolution.test.hpp\"\
    ...
    \n  superset_zeta(B);\r\n  FOR(i, len(A)) A[i] *= B[i];\r\n  superset_mobius(A);\r\
    \n  return A;\r\n}\r\n#line 6 \"test/library_checker/convolution/bitwise_and_convolution.test.hpp\"\
  ...
  verifiedWith: []
documentation_of: test/library_checker/convolution/bitwise_and_convolution.test.hpp
layout: document
redirect_from:
- /verify/test/library_checker/convolution/bitwise_and_convolution.test.hpp
- /verify/test/library_checker/convolution/bitwise_and_convolution.test.hpp.html
