...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/datastructure/static_range_sum.test.cpp\"\
    ...
    \ && i < j); });\n  return ids;\n}\n#line 4 \"test/library_checker/datastructure/static_range_sum.test.cpp\"\
    \n\r\nvoid solve() {\r\n  LL(N, Q);\r\n  VEC(ll, A, N);\r\n  A = cumsum(A);\r\n\
    \  FOR(_, Q){\r\n    LL(L, R);\r\n    print(A[R] - A[L]);\r\n  }\r\n}\r\n\r\n\
...
layout: document
redirect_from:
- /verify/test/library_checker/datastructure/static_range_sum.test.cpp
- /verify/test/library_checker/datastructure/static_range_sum.test.cpp.html
