...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/math/sum_of_exp_times_poly_limit.test.cpp\"\
    ...
    \ a, ll N) {\r\n  // table of a^i\r\n  vc<mint> f(N, 1);\r\n  FOR(i, N - 1) f[i\
    \ + 1] = a * f[i];\r\n  return f;\r\n}\r\n\r\ntemplate<typename mint, int LIM>\r\
    \nvc<mint> powertable_2(ll e, ll N) {\r\n  // table of i^e. LIM \u4EE5\u4E0B\u306E\
    \u7D20\u6570\u30C6\u30FC\u30D6\u30EB\u3092\u5229\u7528\u3059\u308B. \r\n  auto\
    ...
    \n  LL(d);\r\n  int L = d + 5;\r\n  vc<mint> a = powertable_2<mint, 10'000'000>(d,\
    \ L);\r\n  mint p = 1;\r\n  FOR(i, L) {\r\n    a[i] *= p;\r\n    p *= r;\r\n \
  ...
  code: "#define PROBLEM \\\r\n  \"https://judge.yosupo.jp/problem/sum_of_exponential_times_polynomial_limit\"\
    ...
    \ {\r\n  mint r;\r\n  scanner.read(r);\r\n  LL(d);\r\n  int L = d + 5;\r\n  vc<mint>\
    \ a = powertable_2<mint, 10'000'000>(d, L);\r\n  mint p = 1;\r\n  FOR(i, L) {\r\
  ...
  requiredBy: []
  timestamp: '2022-01-13 13:13:24+09:00'
