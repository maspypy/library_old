...
data:
  ...
  bundledCode: "#line 1 \"test/ds/fenwick.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/point_add_range_sum\"\
    ...
    \  merge(all(A), all(B), back_inserter(C));\n  return C;\n}\n#line 3 \"test/ds/fenwick.test.cpp\"\
  ...
  requiredBy: []
  timestamp: '2021-12-25 23:32:45+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/ds/fenwick.test.cpp
layout: document
redirect_from:
- /verify/test/ds/fenwick.test.cpp
- /verify/test/ds/fenwick.test.cpp.html
