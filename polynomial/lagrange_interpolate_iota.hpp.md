...
documentation_of: polynomial/lagrange_interpolate_iota.hpp
layout: document
redirect_from:
- /library/polynomial/lagrange_interpolate_iota.hpp
- /library/polynomial/lagrange_interpolate_iota.hpp.html
